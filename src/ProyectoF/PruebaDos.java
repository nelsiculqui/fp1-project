...
los arreglos de los productos que se compran y venden */
        String[] CodProductos = {"C0001","C0002","N0003","N0004","N0005","N0006","N0007","N0008","F0009","F0010","F0011","F0012","F0013","F0014"};
        String[] DescripcionCod = {"CEMENTO ANDINO TIPO 1","CEMENTO SOL TIPO 1","CLAVO ALBAÑIL CON CABEZA 2 1/2 X 1 KG- PRODAC","CLAVO ALBAÑIL CON CABEZA 2 X 1 KG- PRODAC",
                "CLAVO ALBAÑIL CON CABEZA 2X 1 KG- PRODAC","CLAVO ALBAÑIL CON CABEZA 3 X 1 KG- PRODAC","CLAVO ALBAÑIL CON CABEZA 4 X 1 KG- PRODAC" ,"CLAVO ALBAÑIL CON CABEZA 4X 1 KG- PRODAC" ,
                "FIERRO DE 1/2 ACEROS AREQUIPA" ,"FIERRO DE 3/8 ACEROS AREQUIPA" ,"FIERRO DE 4.7MM ACEROS AREQUIPA" ,"FIERRO DE 5/8 ACEROS AREQUIPA" ,"FIERRO DE 6MM ACEROS AREQUIPA" ,"FIERRO DE 8MM ACEROS AREQUIPA"};
    ...
    private static String calcularIGVsunat(int[] cantidadProducto, double[] importeProductoSinIGV, String[] auxiliar) {
        ...
        if(igvsunat>0){
            abc = String.format("El IGV a pagar a SUNAT es = %.2f ",igvsunat);
        } else {
            abc = "Usted cuenta con crédito fiscal";
        }
